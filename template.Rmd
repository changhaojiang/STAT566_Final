...
3. What are the varying effects of lifestyle factors among subgroups characterized by different age, sex, and income levels?
...
plot_income <- ggplot(data, 
     ...
     ggtitle("Figure1a: Income of participants in different 
...
plot_age <- ggplot(data, 
     ...
     theme_bw() +
     theme(axis.text.x = element_text(angle = 45, hjust = 1))+
     ggtitle("Figure1b: Age of participants in different 
             lifestyle score category and diabetes status")
plot_age
...
plot_gender <- ggplot(data, 
     ...
     theme_bw() +
     theme(axis.text.x = element_text(angle = 45, hjust = 1))+
     ggtitle("Figure1c: Gender of participants in different 
             lifestyle score category and diabetes status")
plot_gender
```
...
ggplot(plotdata, aes(x = Income_Group, y = Estimator, fill = Income_Group)) + 
  geom_boxplot() + 
  ggtitle("Figure2a: The result of R-learner(Income)") +
  xlab("Income Group") +
  ylab("Estimator") +
...
ggplot(plotdata, aes(x = Gender_Group, y = Estimator, fill = Gender_Group)) + 
  geom_boxplot() + 
  ggtitle("Figure2b: The result of R-learner(Gender)") +
  xlab("Gender Group") +
  ylab("Estimator") +
...
ggplot(plotdata, aes(x = Age, y = Estimator, fill = Age)) + 
  geom_boxplot() + 
  ggtitle("Figure2c: The result of R-learner(Age)") +
  xlab("Age Group") +
  ylab("Estimator") +
...
In the results of logistic regression with adjustment (Table 2), we can see the potential causal effect of the adjusted lifestyle combination score on odds of developing diabetes is 0.6856, which is larger than the coefficient of the unadjusted lifestyle combination score on the odds of diabetes, which is 0.5499.
